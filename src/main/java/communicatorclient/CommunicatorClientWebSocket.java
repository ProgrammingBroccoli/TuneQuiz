...
public class CommunicatorClientWebSocket extends Communicator {
    ...
    //TODO: DIFFERENT METHODS WIL BE IMPLEMENTED HERE FOR SENDING MESSAGES
//    @Override
//    public void sendScoreToServer(Category category, int score){
//        MessageCreator messageCreator = new MessageCreator();
//        MessageUpdateScore messageUpdateScore = new MessageUpdateScore();
//        messageUpdateScore.setCategory(category);
//        messageUpdateScore.setScore(score);
//        sendMessageToServer(messageCreator.createMessage(MessageOperationType.UPDATE_SCORE, messageUpdateScore));
//
//    }
